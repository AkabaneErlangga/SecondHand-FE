...
const Login = () => {
    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 h-screen w-full'>
            <div className='hidden sm:block bg-register'>
            ...
            <div className='flex flex-col justify-center'>
                <form className='max-w-[400px] w-full mx-auto mx-auto bg-gray-100 p-8 px-8 rounded-2xl'>
                    ...
                    <div>
                        <p className='text-black text-center p-5'>Belum punya akun? <button className='text-purple-500'>Daftar di sini</button></p>
                    </div>
                </form>
            </div>
